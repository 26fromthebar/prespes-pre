...
document.addEventListener('DOMContentLoaded', async () => {
  const response = await axios.get(
    'https://api.weatherapi.com/v1/current.json?key=92eab374f8c14f52bb4115634221403&q=40.83628,21.14061'
  );
...
function changeHeaderAndAside() {
  window.scrollY > 100 ? addClassScrolled() : removeClassScrolled();
}
